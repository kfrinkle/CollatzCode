			...
			if (num64hold[num64Size - 1] != 1UL)
			{
				...
				for (int i = i3; i < powa2; i++)
				{
					...
					if (SKIPEVENS)
					{
						...
						{
							sizeNum = addUL64(num64hold, 4UL, sizeNum);
							streakChunk = streakChunk + 3;
							i = i + 3;
						}
						else
						{
							sizeNum = addUL64(num64hold, 2UL, sizeNum);
							streakChunk = streakChunk + 1;
							i = i + 1;
						}
					}
					else
					{
						if ((num64hold[0] & 7UL) == 4UL)
						{
							sizeNum = addUL64(num64hold, 2UL, sizeNum);
							streakChunk = streakChunk + 1;
							i = i + 1;
				...
				if (streakChunk > powa2)
				{
					MPI_Send(&powa2, 1, MPI_INT, 0, 0, MPI_COMM_WORLD);
				}
				else
				{
